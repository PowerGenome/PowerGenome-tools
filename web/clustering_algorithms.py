...
This module contains pure algorithmic functions for clustering balancing authorities (BAs)
into model regions based on transmission network topology.

Includes multiple clustering methods:
- Agglomerative clustering (hierarchical with various linkage methods)
- Spectral clustering (eigenvalue-based)
- Louvain community detection (modularity-based)
- Hierarchical clustering with grouping column constraints

These functions are pure Python logic operating on networkx graphs and numpy arrays,
with no PyScript/DOM dependencies.
"""
...
# Import ESR utils for ESR-compatible clustering

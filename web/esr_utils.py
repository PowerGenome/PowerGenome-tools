"""
ESR (Energy Share Requirements) Utility Functions

This module contains functions for handling RPS/CES policy generation,
state trading zones, and emission policies CSV generation.

These functions are pure Python logic operating on pandas DataFrames
and have no PyScript/DOM dependencies.
"""

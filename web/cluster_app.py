...
# Suggested local folder (under DATA_ROOT_EXAMPLE) for the resource-group files
# the web app itself generates for new-build wind/solar (Step 7). PowerGenome's
# RESOURCE_GROUPS setting accepts a list of folders; the example data.yml
# snippet lists both this folder and the existing-resource-groups deposit.
WEB_APP_RESOURCE_GROUPS_FOLDER = "new_build_resource_groups"
...
DATA_SOURCES = [
    ...
    },
    {
        ...
        "description": (
            ...
            "(Interconnection) of this web app."
        ),
        "url": "https://zenodo.org/",  # TODO: replace with deposit URL when published
        "doi": "DOI pending (first publish upcoming)",
...
NEW_BUILD_RESOURCE_GROUPS_NOTE = (
    "The second RESOURCE_GROUPS entry is the local folder where you save the "
    "resource group files you download in Step 7 (Interconnection) of this web "
    "app — these are the new-build wind/solar resource groups. The first entry "
    "points to the existing resource groups deposit listed above."
)
...
def build_data_yml_snippet():
    ...
    return (
        ...
        f'  - "{DATA_ROOT_EXAMPLE}/{WEB_APP_RESOURCE_GROUPS_FOLDER}"\n'
...
def generate_data_settings():
    ...
    out = {
        ...
        "RESOURCE_GROUPS": [
            ...
            # new-build wind/solar resource groups generated by this web app

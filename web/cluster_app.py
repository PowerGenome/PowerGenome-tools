...
from clustering_algorithms import (
    ...
    generate_cluster_names as _generate_cluster_names_algo,
    generate_yaml,
)
...
def generate_cluster_names(clusters, groups):
    """Wrapper for generate_cluster_names that passes state.hierarchy_df."""
    return _generate_cluster_names_algo(clusters, groups, state.hierarchy_df)
def run_clustering(
    selected_bas,
    grouping_column,
    target_regions,
